    ...
    return (
        ...
        >
            <div className="payment__page__left__wrapper">
                <p className="payment__page__left__wrapper__title">
                    Cart totals
                </p>
                ...
                <div className="payment__page__shipping__options__display">
                    <p>
                        Shipping:(please select an option best suited to your
                        order)
                    </p>
                    <div className="payment__page__shipping__options">
                        <div className="payment__page__shipping__option">
                            ...
                            <label
                                ...
                                name="drone"
                            >
                                Local Overnight – A Flyer/Bag For Up To 2kg:
                                R70.00
                            </label>
                        </div>
                        <div className="payment__page__shipping__option">
                            ...
                            <label className="payment__page__shipping__option__label">
                                Local Overnight - A Box For Up To 30kg - Not
                                Bigger Then 500mm X 500mm X 500mm: R95.00
                            </label>
                        </div>
                        <div className="payment__page__shipping__option">
                            <input
                            ...
                            />
                            <label className="payment__page__shipping__option__label">
                                Overnight Courier - A Flyer/Bag Up To 2kg -
                                Major Centers - NO LIPOS: R120.00
                            </label>
                        </div>
                        <div className="payment__page__shipping__option">
                            <input
                            ...
                            <label className="payment__page__shipping__option__label">
                                Overnight Courier - A Flyer/Bag Up To 2kg -
                                Regional Areas - NO LIPOS: R120.00
                            </label>
                        </div>
                        <div className="payment__page__shipping__option">
                            <input
                            ...
                            />
                            <label className="payment__page__shipping__option__label">
                                Road Freight - A Flyer/Bag Up To 2kg - Major
                                Centers: R135.00
                            </label>
                        </div>
                        <div className="payment__page__shipping__option">
                            ...
                            />
                            <label className="payment__page__shipping__option__label">
                                Road Freight - A Flyer/Bag Up To 2kg - Regional
                                Areas: R135.00
                            </label>
                        </div>
                        <div className="payment__page__shipping__option">
                            ...
                            />
                            <label className="payment__page__shipping__option__label">
                                Economy Road - Anything Up To 15kg – Inside A
                                450mm X 450mm X 450mm Box - Major Centers –
                                Delivery Within 2 To 3 Working Days: R195.00
                            </label>
                        </div>
                        <div className="payment__page__shipping__option">
                            <input
                            ...
                            <label className="payment__page__shipping__option__label">
                                Economy Road - Anything Up To 15kg - Inside A
                                450mm X 450mm X 450mm Box - Regional Areas –
                                Delivery Within 3 To 5 Working Days: R195.00
                            </label>
                        </div>
                    </div>
                </div>
