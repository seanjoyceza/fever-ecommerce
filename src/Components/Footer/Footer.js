    ...
    <div className='footer'>
          ...
          <div className='footer__links-holder-right'>
            <div className='footer__links-holder'>
              ...
              <ul className='footer__list'>
                ...
                <li className='footer__option'>
                  <Link className='footer__link' to='solutions'>
                    Solutions
                  </Link>
                </li>
            ...
            <div className='footer__contact-holder'>
              <h3 className='footer__contact-header'>
                Get In Touch <MailOutlineIcon className='mail' />
              </h3>
              <div className='footer__contact-email'>
                <p>shaun@merge-iot.com</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='footer__bottom'>
        <div className='footer__bottom-section'>
          ...
          <a href='https://www.normanlly.com/' className='normanlly__link'> <p className='normanlly__link__text'>Created by Normanlly</p></a>
